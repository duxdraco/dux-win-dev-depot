...
maintainers via the repository's
[private security advisory form](https://github.com/duxdraco/dux-win-dev-depot/security/advisories/new)
or through a private message to the maintainer. All complaints will be reviewed and
...
1. **Correction** — Private, written warning, with clarity around the nature of the
